<!--
WP5f Title + Abstract + Keywords. Written last to reflect the real content.
Abstract: unstructured, ~200 words (IJPVP exact limit ⚠ unconfirmed; 150-250 norm used).
Keywords: IJPVP rule = 1-7, no "and"/"of" multi-word conjunctions, established abbreviations OK.
Title: <=15 words (15).
-->
...
<!-- 15 words. Captures SCF + fatigue + ripple + large-diameter X70. -->
...
API 5L X70; Mild ripple; Stress concentration factor; Finite element analysis; Markl–Miner fatigue; Fitness-for-service

<!-- 6 keywords; no "and"/"of" multi-word conjunctions; FEA-domain terms; established hyphenations only. -->

<!--
DRAFT NOTES (WP6a):
- Abstract headline number = closed-form SCF_crit ~1.56 (anchor; 1.5619 exact, WP6 Faz 5 correction), consistent with Discussion 4.1.
- Quantitative claims kept: SCF range 1.42-2.37, R2=0.916, ~1.56 threshold.
